...
//         $rate1 = Recei_Add::where('pawn_amount', '>=', 100000)
//             ->value('rate3');  // For amounts greater than 1000000
    
//         $rate2 = Recei_Add::whereBetween('pawn_amount', [50000, 99999])
//             ->value('rate3');  // For amounts between 50,000 and 99,999
    
//         $rate3 = Recei_Add::where('pawn_amount', '<', 50000)
//             ->value('rate3');  // For amounts less than 50,000
    
//         // Check the range of the pawning amount and assign the correct interest rate
//         if ($pawning_amount >= 100000) {
//             $interestRate = $rate1;  // Fallback to 1.68 if rate1 is not found
//         } elseif ($pawning_amount >= 50000 && $pawning_amount <= 99999) {
//             $interestRate = $rate2;  // Fallback to 2 if rate2 is not found
//         } else {
//             $interestRate = $rate3;  // Fallback to 2.5 if rate3 is not found
//         }
    
//         // If receipt value exists, pass the data to the view
//         if ($receiptValue != null) {
//             return view('pawning_get_total')
//                 ->with('amount', $amount)
//                 ->with('pawning_amount', $pawning_amount)
//                 ->with('InterestRate', $interestRate)  // Pass the dynamically set interest rate
