...
<script>
    ...
    let totalPay = interest_to_pay + document_charges + stamp_duty + amount + Postage_Charges;
    ...
    $('#BalanceInterest').val(((interest_to_pay + Postage_Charges) - interest_Paid).toFixed(2));
