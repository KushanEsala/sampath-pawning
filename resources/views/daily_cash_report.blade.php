...
<body>
    <div class="report-header">
        <h2>PT31 - Daily Cash A/C Report</h2>
    </div>
    ...
    <div class="report-info">
        ...
        <p><strong>Branch :</strong> {{ $branchCode ?? auth()->user()->Branch }}</p>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">{{ $row['dr_amount'] != '0' ? $row['dr_amount'] : '-' }}</td>
                <td class="text-right">{{ $row['cr_amount'] != '0' ? $row['cr_amount'] : '-' }}</td>
