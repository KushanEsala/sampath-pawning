...
@section('content')
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 margin-tb">
                                ...
                                <div class="pull-right mb-2">
                                    <a class="btn btn-warning card-body shadow p-3 mb-5" onClick="add()" href="javascript:void(0)">Add Payment Voucher </a>
                                </div>
                            </div>
                        </div>
    ...
    if (confirm("Approve this Record?") == true) {
        ...
        $.ajax({
            type:"POST",
            url: "{{ url('ApprovalPaymentVoucher') }}",
            data: { id: id },
            dataType: 'json',
            success: function(res){
                if(res.success){
