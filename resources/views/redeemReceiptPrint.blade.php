        ...
        <table>
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <td>
                        @foreach($redeemdata as $sumData)
                            {{ number_format($sumData['Original_Pawn_Amount'], 2, '.', ',') }}
                        @endforeach
                    </td>
                </tr>
                ...
                {{-- INTEREST --}}
                <tr>
                    <td colspan="2"><strong>Interest Received A/C <small>({{ $interestDays }} days)</small></strong></td>
                      <td>
                        @foreach($redeemdata as $sumData)
                            {{ number_format($sumData['Paid_Interest'], 2, '.', ',') }}
                        @endforeach
                    </td>
                </tr>
                ...
                {{-- PAYABLE --}}
                <tr>
                    <td colspan="2"><strong>Document Charges</strong></td>
                    <td>
                        @foreach($redeemdata as $sumData)
                            {{ number_format($sumData['Document_Charges'], 2, '.', ',') }}
                        @endforeach
                    </td>
                </tr>
                  ...
                  {{-- PAYABLE --}}
                <tr>
                    <td colspan="2"><strong>Postage Charges</strong></td>
                    <td>
                        @foreach($redeemdata as $sumData)
                            {{ number_format($sumData['Postage_Charges'], 2, '.', ',') }}
                        @endforeach
                    </td>
                </tr>
