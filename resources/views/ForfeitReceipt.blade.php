                    ...
                    <div class="col">
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('store_forfeit')}}" method="post"
                                    onsubmit="return confirm('Are you sure, want to FORFEIT?');">
                                    @csrf
                                    <div class="row ">
                                        <div class="row form-group ">
                                            <div class="col-md-4 mb-1">
                                                <label for="receipt_no">Receipt Number :
                                                    ...
                                                    name="receipt_number" id="search_receipt" value="{{ $prefillReceiptNumber ?? '' }}">
                                                </label>
                                            </div>
                                            <div class="col-md-4 mb-1">
                                                <label for="invoice_no">Invoice Number :
                                            ...
                                            <div class="dynamic-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <label for="Forfeit_no">Forfeit Number :
                                                                <input class="form-control" type="text" placeholder="Forfeit Number:" id="forfeit_no" name="forfeit_no">
                                                            </label>
                                                        </div>
                                                        <div class="col">
                                                            <label for="pawn_receipt_type">Pawn Receipt Type :
                                                                <input class="form-control" type="text" placeholder="Pawn Receipt Type:"
                                                                value=""
                                                                id="pawn_receipt_type" name="pawn_receipt_type" required>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <h5 class="mt-3">Forfeit Details</h5>
                                                <table class="table table-bordered text-center" id="dynamicAdded">
                                                    <thead class="thead-light">
                                                        <tr>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <button class="btn btn-lg btn-outline-info  form-control" name="forfeit" type="submit">FORFEIT</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
...
<script>
    $(document).ready(function(){
        ...
        $('#search_receipt').on('keyup',function(e){
            ...
            $.ajax({
                url:"{{ route('search_receipt_for_forfeit_ajax') }}",
                method:'GET',
        ...
        if ($('#search_receipt').val().trim()) $('#search_receipt').trigger('keyup');
    });
</script>
...
<script>
    $(document).ready(function(){
        ...
        $('#search_invoice').on('keyup',function(e){
            ...
            $.ajax({
                url:"{{ route('search_invoice_for_forfeit_ajax') }}",
                method:'GET',
