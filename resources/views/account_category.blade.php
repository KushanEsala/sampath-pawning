        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                <div class="card shadow">
                    <div class="col-md-9">
                        <h4 class="card-title m-3">Account Category</h4>
                    </div>
                                                            ...
                                                            <form action="" method="post" id="updateItemCategory">
                                                                ...
                                                                <div class=" form-group">
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        name="up_CategoryName" id="up_CategoryName"
                                                                        required>
                                                                </div>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.add_category', function (e) {
            ...
            $.ajax({
                url: "{{ route('add_Account_Category_ajax') }}",
                method: 'post',
                data: {
                    "_token": "{{ csrf_token() }}",
                    code: code,
                ...
                success: function (res) {
                    if (res.status == 'success') {
                        ...
                        Command: toastr["success"]("Account Category Added ...!", "Success")
                        toastr.options = {
                            "closeButton": true,
                            "debug": false,
                            "newestOnTop": false,
        ...
        $(document).on('click','.update_category',function(e){
                        ...
                        $.ajax({
                            url:"{{ route('update_Account_Category_ajax') }}",
                            method: 'post',
                            ...
                            success:function(res){
                                if(res.status=='success'){
                                    ...
                                    $('.table').load(location.href+' .table');
                                    Command: toastr["success"]("Account Category Updated...", "Success")
                                        toastr.options = {
                                        "closeButton": true,
                                        "debug": false,
                                        "newestOnTop": false,
        ...
        $(document).on('click', '.delete_category', function (e) {
            ...
            if (confirm('Are you sure to delete Account Category ?')) {
                $.ajax({
                    url: "{{ route('delete_Account_Category_ajax') }}",
                    method: 'post',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        id: id
                    ...
                    success: function (res) {
                        if (res.status == 'success') {
                            $('.table').load(location.href + ' .table');
                            Command: toastr["success"]("Account category deleted...", "Success")
                            toastr.options = {
                                "closeButton": true,
                                "debug": false,
                                "newestOnTop": false,
